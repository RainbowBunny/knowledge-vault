...
- Used in essentially every `[!theorem]` block in [[Symmetric Key Encryption]], [[Public-Key Encryption]], [[Pseudorandom Function]], and the [[Digital Signatures MOC|signatures]] and [[Zero-knowledge MOC|ZK]] files.
