...
> 3. The [[Lattice Bounds#Gaussian heuristic|Gaussian heuristic]] predicts that the shortest nonzero vector in the NTRU lattice has length $$\sigma (L_h^{\text{NTRU}}) \approx \sqrt{\frac{Nq}{\pi e}} \approx 0.484 N.$$ 
> 
