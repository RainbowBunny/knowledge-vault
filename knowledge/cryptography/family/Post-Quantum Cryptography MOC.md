...
- [[Lattice Trapdoor]] — definitions, bases, trapdoors
...
## Code-Based (codes in `information theory/coding theory/`)
...
- [[Hamming Quasi-Cyclic]] (`primitive/key establishment/kem/scheme/`) — NIST's backup KEM, composing systematic + quasi-cyclic
