...
> [!remark]
> $\text{SUBSET-SUM} = \{\langle S, t \rangle | S = \{x_1, \cdots, x_k\}, \text{ and for some} \{y_1, \cdots, y_l\} \subseteq S, \text{we have } \sum y_i = t\}$ is in [[Hardness and Completeness|NP-Complete]].
