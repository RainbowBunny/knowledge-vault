...
> Lambda calculus, term rewriting, the grammars and automata of [[Language]], and Turing machines are formal systems that are not logics. The [[Complexity MOC|complexity]] and `computability/` folders study formal systems whose derivations are *computations*.
