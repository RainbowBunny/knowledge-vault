...
> 	3. Samples $\mathbf{x} \leftarrow \mathcal D_{\Lambda_q^\perp(\mathbf{g}) + \mathbf{c}, r}$ ([[Discrete Gaussian Distribution#Basic Definition|Discrete Gaussian]] of [[Lattices#$q$-ary Lattices|q-ary Lattices]]).
