...
> Two sets $A$ and $B$ are **equals**, written $A = B$, if they consist of exactly the same elements. If one contains an element the other does not, they are unequal, written $A \neq B$.
