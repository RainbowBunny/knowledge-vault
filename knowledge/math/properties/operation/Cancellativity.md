...
> ---
> ### Property
> A binary operation $\star$ is cancellative iff for all $a, x, y \in O$:
> - $a \star x = a \star y \implies x = y$ (Left Cancellative).
> - $x \star a = y \star a \implies x = y$ (Right Cancellative).
